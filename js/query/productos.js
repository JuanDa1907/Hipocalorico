...
function listar() {
    $.ajax({
        ...
        url: "http://129.159.61.231:8080/api/supplements/all",
...
function listarxPrecio() {
    ...
    if(!validaesVacio(precio)) {
        ...
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: `http://129.159.61.231:8080/api/supplements/price/${precio}`,
...
function listarxDescripcion() {
    ...
    if(!validaesVacio(descripcion)) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: `http://129.159.61.231:8080/api/supplements/description/${descripcion}`,
